...
void about() {
	...
	if (isEnglish)
		...
		std::cout << u8"Giáo_viên_hướng_dẫn:Trương Toàn Thịnh";
	SetConsoleTextAttribute(hConsole, (15 << 4) | 11);
	GotoXY(30, 12); std::cout << u8"██████████████████████████████████████████████████████████" << "\n";
	SetConsoleTextAttribute(hConsole, (11 << 4) | 0);
	GotoXY(35, 12); std::cout << u8"NHÓM 04:";
	SetConsoleTextAttribute(hConsole, (15 << 4) | 11);
	GotoXY(30, 13); std::cout << u8"██████████████████████████████████████████████████████████" << "\n";
	SetConsoleTextAttribute(hConsole, (11 << 4) | 0);
	GotoXY(45, 13);
	if (isEnglish) std::cout << u8"+Đỗ Ngọc Gia Bảo - Leader(24120263)";
	else std::cout << u8"+Đỗ Ngọc Gia Bảo - Nhóm trưởng(24120263)";
	SetConsoleTextAttribute(hConsole, (15 << 4) | 11);
